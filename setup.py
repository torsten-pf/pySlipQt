...
setup(name='pySlipQt',
      ...
      license='MIT',
      packages=['pySlipQt'],
      install_requires=['pyqt5', 'python3'],
      ...
      data_files=[('', ['README.rst',
                        ...
                        'LICENSE',
                        'Makefile',
                        'Release_Notes_0.1.txt',
                        'setup.py',
                       ]),
                  ('pySlipQt/examples', ['pySlipQt/examples/README.rst',
      ...
      download_url='https://github.com/rzzzwilson/pySlipQt/releases/tag/0.1.5',
